...
<body>
	...
	<a href="https://www.egovframe.go.kr/docs/5.0/egovframe-runtime/foundation-layer/crypto/crypto-simplification/" target="_blank">실행환경 Crypto 설정간소화 관련 가이드 참조</a><br /><br /><br />
